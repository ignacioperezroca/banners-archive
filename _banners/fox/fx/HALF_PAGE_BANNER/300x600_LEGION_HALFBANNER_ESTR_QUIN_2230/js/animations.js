...
function funcAnm06() {
  document.querySelector('.img-frame--03').classList.add("fadeIn");
  document.querySelector('.img-frame--03').classList.add("leftIn");
}
function funcAnm07() {
  document.querySelector('.img-frame--04').classList.add("fadeIn");
  document.querySelector('.img-frame--04').classList.add("leftIn");
}
function funcAnm08() {
  document.querySelector('.img-frame--06').classList.add("fadeIn");
  document.querySelector('.img-frame--06').classList.add("rightIn");
}
function funcAnm09() {
  document.querySelector('.img-frame--05').classList.add("fadeIn");
  document.querySelector('.img-frame--05').classList.add("rightIn");
}
