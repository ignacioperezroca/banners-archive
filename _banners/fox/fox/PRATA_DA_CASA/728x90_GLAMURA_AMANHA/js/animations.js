...
// <!-- STAR FRAME 1 -->
	...
	setTimeout(function(){
		$('.img-frame--02').addClass('fadeIn topIn');
	}, 1500)

	setTimeout(function(){
		$('.img-frame--03').addClass('fadeIn topIn');
	}, 2000)

	setTimeout(function(){
		$('.img-frame--04').addClass('fadeIn rightIn');
	}, 2500)
	...
	setTimeout(function(){
		$('.img-frame--02 , .img-frame--03').addClass('fadeOut');
	}, 5000)

	setTimeout(function(){
		$('.img-frame--06').addClass('fadeIn bottomIn');
	}, 6000)

	setTimeout(function(){
		$('.img-frame--08').addClass('fadeIn rightIn');
	}, 7000)
