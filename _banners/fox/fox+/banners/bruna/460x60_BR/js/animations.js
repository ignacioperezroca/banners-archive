...
// <!-- STAR FRAME 1 -->
	...
	setTimeout(function(){
		$('.typo-subtitle--01').animate({opacity: '1', top: '0px'},{
			duration: 300,
		});
	}, 1200)

	setTimeout(function(){
		$('.typo-paragraph--01').animate({opacity: '1', right: '-10'},{
			duration: 300,
		});
	}, 2000)
	...
	setTimeout(function(){
		...
		$('.typo-paragraph--02').animate({opacity: '1', right: '-10'},{
			duration: 1100,
		});
	}, 2800)
	...
	setTimeout(function(){
		...
		$('.typo-paragraph--03').animate({opacity: '1', right: '-10'},{
			duration: 1100,
		});
	}, 4400)
	...
	setTimeout(function(){
		...
		$('.typo-paragraph--04').animate({opacity: '1', right: '-10'},{
			duration: 1100,
		});
	}, 6000)
