...
// <!-- STAR FRAME 1 -->
  ...
  $('#h1').click(function(){
    ...
    ga('send', 'event', 'button', 'click', 'letra-premium-hula-h');
  });
  
  $('#h2').click(function(){
    $('.img-frame--02').addClass('fadeIn');
    ga('send', 'event', 'button', 'click', 'letra-premium-hoop-h');
  });

  $('#o2').click(function(){
    $('.img-frame--03').addClass('fadeIn');
    ga('send', 'event', 'button', 'click', 'letra-premium-hoop-oo');
  });

  $('#u1').click(function(){
    $('.img-frame--04').addClass('fadeIn');
    ga('send', 'event', 'button', 'click', 'letra-premium-hula-u');
  });

  $('#l1').click(function(){
    $('.img-frame--05').addClass('fadeIn');
    ga('send', 'event', 'button', 'click', 'letra-premium-hula-l');
  });

  $('#a1').click(function(){
    $('.img-frame--06').addClass('fadeIn');
    ga('send', 'event', 'button', 'click', 'letra-premium-hula-a');
  });

  $('#p1').click(function(){
    $('.img-frame--07').addClass('fadeIn');
    ga('send', 'event', 'button', 'click', 'letra-premium-hoop-p');
  });
