...
/*     setTimeout(function(){
		$('.btn').animate({opacity:'1',width:'320px', height:'auto', left:'-15px', marginTop:'-11px'},{
            duration: 300, 
            easing: 'swing', 
        });
	},5000)
    ...
    setTimeout(function(){
		$('.btn').animate({opacity:'1',width:'300px', height:'auto', left:'0px', marginTop:'0px'},{
            duration: 300, 
            easing: 'swing', 
        });
	},5300) */
	...
	setTimeout(function(){
		...
		setTimeout(function(){
			$('.btn').animate({opacity:'1',width:'320px', height:'auto', left:'-15px', marginTop:'-12px'},{
				duration: 300, 
				easing: 'easeOutQuint', 
			});
			//hover
	...
	setTimeout(function(){
		$('.texto-2-back').animate({opacity:'1'},{
            duration: 500, 
            easing: 'swing', 
        });
	},5000)
